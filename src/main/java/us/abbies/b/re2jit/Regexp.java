...
/**
 * Regular expression abstract syntax tree. Produced by parser, used by compiler. NB, this corresponds to
 * {@code syntax.regexp} in the Go implementation; Go's {@code regexp} is called {@code RE2} in Java.
 */
class Regexp {
