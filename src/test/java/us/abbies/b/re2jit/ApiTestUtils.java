...
public class ApiTestUtils {
     ...
     * matches the string {@code match} and doesn't match {@code nonMatch}
     *
     * @param regexp
     * @param match
     * @param nonMatch
    ...
    /**
     * This takes a regex and it's compile time flags, a string that is expected to match the regex and a string that is
     * not expected to match the regex.
     *
    ...
    /**
     * Tests that both RE2 and JDK split the string on the regex in the same way, and that that way matches our
     * expectations.
     */
